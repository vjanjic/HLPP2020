...
void*  create_input() {
    task_t *t = new task_t;
    double musavi=get_current_time();
    ...
    std::cout<<"generated! in time "<< get_current_time()-musavi << std::endl;
...
public:
    ...
    void * svc(void * task ) {
        if (task==NULL) return NULL;
            ...
            std::cout << "cpu finish time " << cpu_end_time-cpu_start_time << "\n";
