...
public:
  ...
  /*
   * This function is used to allow user to add any additional rules he needs 
   * before running the proejct. The default value for this 
   * function returns true meaning that there is no restriction 
   * in any type of devices going to be selected. For example here we force the openCL worker to run on GPU.
   */
