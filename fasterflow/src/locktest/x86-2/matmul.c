...
int workerStage1(int i)
{
	...
	totaltime+=(cpu_end_time - cpu_start_time);
        return 42;
}
...
*/
	...
	double cpu_end_time = get_current_time();
        ...
        fprintf(stderr, "total_lock, %d\n", lock);
        fprintf(stderr, "total_unlock, %d\n", unlock);

        fprintf(stderr, "Average stage 1 time: %f\n", totaltime/N);
        fprintf(stderr, "Total Stage 1 time: %f\n", totaltime);
